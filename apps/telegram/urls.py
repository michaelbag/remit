...
urlpatterns = [
    ...
    # Admin endpoints
    path('admin/send-broadcast/<uuid:broadcast_id>/', views.admin_send_broadcast, name='admin_send_broadcast'),
    ...
    path('api/broadcasts/<uuid:broadcast_id>/send/', api_views.send_broadcast, name='api_send_broadcast'),
    path('api/broadcasts/<uuid:broadcast_id>/stats/', api_views.get_broadcast_stats, name='api_broadcast_stats'),
    path('api/broadcasts/<uuid:broadcast_id>/deliveries/', api_views.get_broadcast_deliveries, name='api_broadcast_deliveries'),
    ...
    path('api/rbac/user-permissions/<uuid:telegram_user_id>/', api_views.get_user_permissions, name='api_telegram_user_permissions'),
