    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equip_code', models.CharField(blank=True, max_length=50, verbose_name='Equipment code')),
                ('employee', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='org.employee')),
                ('parent', models.ForeignKey(blank=True, limit_choices_to={'is_folder': True}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='elements', to='equipment.equipment')),
