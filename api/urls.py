...
urlpatterns = [
    ...
    path('ping/<str:model_name>/<uuid:pk>/', views.CheckObjectView.as_view(), name='ping_model'),
    path('qr-codes/modified-count/', views.QRCodeModifiedCountView.as_view(), name='qr_codes_modified_count'),
